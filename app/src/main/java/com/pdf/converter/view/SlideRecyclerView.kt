 ...
 * @description : 支持侧滑删除的RecyclerView
 */
class SlideRecyclerView @JvmOverloads constructor(
    ...
    private var mLastX = 0f // 滑动过程中记录上次触碰点
    ...
    private var isScroll: Boolean = false // 是否支持滑动
    ...
    fun isMenu(): Boolean = mFlingView != null && mFlingView!!.scrollX != 0
