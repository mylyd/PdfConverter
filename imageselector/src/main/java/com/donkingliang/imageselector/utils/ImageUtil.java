...
//         计算出实际宽度和目标宽度的比率
     ...
     * @param setDark
     */
    public static void changStatusIconColor(Activity activity, boolean setDark) {
     ...
     * @param layout
     */
    public static void initActionBarHeight(Activity activity, @IdRes int layout) {
        View view = activity.findViewById(layout);
        view.setPadding(
                view.getPaddingLeft(),
                getStatusBarHeight(activity) + view.getPaddingTop(),
                view.getPaddingRight(),
                isNavigationVisible(activity) ?
     ...
     * @return
     */
    public static boolean isNavigationVisible(Activity activity) {
