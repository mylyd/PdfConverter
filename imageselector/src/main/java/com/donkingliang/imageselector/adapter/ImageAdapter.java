...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ViewHolder> {
    ...
    private void checkedImage(ViewHolder holder, Image image) {
        if (mSelectImages.contains(image)) {
            ...
            TrackLocalBroadcast.sendBroadcast(mContext, TrackLocalBroadcast.LIMITED_QUANTITY);
            Toast.makeText(mContext, mContext.getString(R.string.selector_task_limited), Toast.LENGTH_SHORT).show();
        }
    }
