...
public class ImageSelectorActivity extends AppCompatActivity {
    ...
    private void initListener() {
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TrackLocalBroadcast.sendBroadcast(ImageSelectorActivity.this, TrackLocalBroadcast.IMAGE_TO_PDF_COMPLETE);
                confirm();
            }
        });

        findViewById(R.id.btn_folder_name).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isInitFolder) {
                    if (isOpenFolder) {
    ...
    private void setSelectImageCount(int count) {
        if (count == 0) {
            ...
            tvConfirm.setText(R.string.selector_complete);
            ...
            if (isSingle) {
                ...
                tvConfirm.setText(getString(R.string.selector_complete) + "(" + count + "/" + mMaxCount + ")");
            } else {
                tvConfirm.setText(getString(R.string.selector_complete) + "(" + count + ")");
            }
        }
    }
